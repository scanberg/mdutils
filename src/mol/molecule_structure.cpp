...
bool init_molecule_structure(MoleculeStructure* mol, int32 num_atoms, int32 num_bonds, int32 num_residues, int32 num_chains,
                             int32 num_backbone_segments, int32 num_backbone_sequences, int32 num_hydrogen_bond_donors, int32 num_hydrogen_bond_acceptors) {
    ...
    mol->backbone_sequences = {(BackboneSequence*)(mol->backbone_segments.end()), num_backbone_sequences};
    mol->hydrogen_bond.donors = {(HydrogenBondDonor*)(mol->backbone_sequences.end()), num_hydrogen_bond_donors};
