...
void draw_vdw(GLuint atom_position_buffer, GLuint atom_radius_buffer, GLuint atom_buffer, int32 atom_count, const ViewParam& view_param, float radius_scale = 1.f, vec4 color = vec4(1, 1, 1, 1));
